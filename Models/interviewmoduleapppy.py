...
import numpy as np
import json
from interview_module import extract_text_from_docx, generate_interview_questions, record_audio, save_audio, speech_to_text, evaluate_answer, read_text_aloud
